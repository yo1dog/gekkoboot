...
If the selected shortcut file cannot be loaded, iplboot will fallback to `/ipl.dol`. If that cannot be loaded either, iplboot will reboot to the onboard IPL (original GameCube intro and menu).
